    ...
    <section className="rounded-t-xl bg-blue-500 text-gray-800">
      <div className="container mx-auto max-w-6xl space-y-6 p-6 sm:space-y-12">
        <a
          ...
          href="#"
          className="group mx-auto block max-w-sm gap-3 overflow-hidden rounded-t-xl bg-gray-50 hover:no-underline focus:no-underline sm:max-w-full lg:grid lg:grid-cols-12"
        >
          <img
